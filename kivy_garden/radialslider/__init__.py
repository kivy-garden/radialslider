...
class RadialSlider(Widget):
    ...
    def update_canvas(self, instance, value):
        ...
        track_adjustment = self.thumb_diameter if (self.track_thickness < 
            self.thumb_diameter) else self.track_thickness
